...
app = FastAPI(title='Backstract Generated APIs - coll-eb884f03d5454c89a93e004aac77ad26', debug=False,
              docs_url='/naughty-ritchie-0d95a2d6ede611ef8ff20242ac12000515/docs',
              openapi_url='/naughty-ritchie-0d95a2d6ede611ef8ff20242ac12000515/openapi.json')
...
app.include_router(
    router,
    prefix='/naughty-ritchie-0d95a2d6ede611ef8ff20242ac12000515/api',
    tags=['APIs v1']
)
